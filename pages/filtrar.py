...
def create_card(data):
    ...
    <div style="background-color:#ffffff; padding:10px; border-radius:5px; margin:10px; border:1px solid #ccc;">
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="padding-right: 10px; text-align: left; border-bottom: 1px solid #ccc;"><strong>ID:</strong> {ID_Recepte}</td>
                <td style="padding-left: 10px; text-align: right; border-bottom: 1px solid #ccc;"><strong>Data:</strong> {Data_formatejada}</td>
            </tr>
        </table>
