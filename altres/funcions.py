...
def generar_html_fontawesome(ID_Recepte, titol, data_formatejada, imatge_url, ingredients, temps_preparacio, temps_act):
    return f"""
...
def generar_html_externs(ID_Recepte, titol, data_formatejada, imatge_base64, ingredients, temps_preparacio, temps_act):
    return f"""
    <div style="margin-bottom: 10px">
        <div style="display: grid; grid-template-columns: 1fr; grid-template-rows: auto auto auto auto; gap: 10px; border: 1px solid #ff3333; border-radius: 10px; padding: 0px; background-color: #ffd1b3;">
            <!-- Primera fila: Imatge i Títol -->
            ...
            <div style="display: flex; align-items: flex-start; grid-column: 1 / span 1;">
                ...
                <div style="text-align: left; padding-left: 10px;">
                    <div style="display: flex; flex-direction: row; align-items: center; gap: 0px;">
                        <h4 style="color: #000099; margin: 0;padding-bottom: 0;">{ID_Recepte}</h4>
